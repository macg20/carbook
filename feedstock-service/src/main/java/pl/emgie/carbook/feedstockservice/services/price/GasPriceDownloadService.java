...
@Service
@Qualifier("gasPriceService")
public class GasPriceDownloadService extends BaseService implements FeedstockPriceDownloadService {

    private String downloadPageUrl;

    public GasPriceDownloadService(@Value("${feedstock.fuel.page.url}") String downloadPageUrl) {
    ...
    public BigDecimal getPrice() {
        ...
        try {
            ...
            return new BigDecimal(StringUtils.replaceCommaToDot(rows.get(3).select("td").get(2).text()));
        } catch (Exception e) {
